...
sudo mkdir -p $DIR
sudo chmod 0755 $DIR
sudo --preserve-env=http_proxy,https_proxy,ftp_proxy,no_proxy debootstrap --arch=amd64 --include=$PREINSTALL_PKGS --components=main,contrib,non-free,non-free-firmware $RELEASE $DIR
